...
def test_parse_str_args():
    ...
    parser = SchemedArgumentParser(schema=Schema1)
    args = parser.parse_schemed_args(["--settings", "123"])
...
def test_parse_int_args():
    ...
    parser = SchemedArgumentParser(schema=Schema2)
    args = parser.parse_schemed_args(["--settings", "123"])
...
def test_parse_str_enum_args():
    ...
    parser = SchemedArgumentParser(schema=Schema3)
    args = parser.parse_schemed_args(["--settings", "c"])
...
def test_parse_int_enum_args():
    ...
    parser = SchemedArgumentParser(schema=Schema4)
    args = parser.parse_schemed_args(["--settings", "2"])
...
def test_parse_positional_args():
    ...
    parser = SchemedArgumentParser(schema=Schema5, positional_arguments=("abc",))
...
def test_parse_short_aliases():
    ...
    parser = SchemedArgumentParser(schema=Schema6, short_aliases={"settings": "b"})
...
def test_parse_field_aliases():
    ...
    parser = SchemedArgumentParser(schema=Schema7)
